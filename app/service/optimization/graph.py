...
def _make_node(
    agent_fn: Callable[[CVOptimizationState, LLMConnector], Awaitable[dict[str, Any]]],
    llm: LLMConnector,
) -> Any:
...
def build_cv_optimization_graph(llm: LLMConnector) -> CompiledStateGraph[Any, Any, Any]:
