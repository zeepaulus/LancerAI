...
class JobListing(Base):
    ...
    job_matches = relationship("JobMatchResult", back_populates="job_listing", lazy="selectin")
    interview_sessions = relationship("InterviewSession", back_populates="job_listing", lazy="selectin")
